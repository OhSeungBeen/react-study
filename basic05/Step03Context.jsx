...
const Step03Context = createContext({
...
const Step03Provider = ({ children }) => {
  ...
  return <Step03Context.Provider value={value}>{children}</Step03Context.Provider>;
};

const { Consumer: Step03Consumer } = Step03Context; // const ColorConsumer = Step03Context.Consumer
export { Step03Provider, Step03Consumer };

export default Step03Context;
